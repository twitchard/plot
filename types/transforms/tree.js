...
export function treeNode({ path = identity, // the delimited path
delimiter, // how the path is separated
frameAnchor, treeLayout = tree, treeSort, treeSeparation, treeAnchor, ...options } = {}) {
...
export function treeLink({ path = identity, // the delimited path
delimiter, // how the path is separated
curve = "bump-x", stroke = "#555", strokeWidth = 1.5, strokeOpacity = 0.5, treeLayout = tree, treeSort, treeSeparation, treeAnchor, ...options } = {}) {
    treeAnchor = maybeTreeAnchor(treeAnchor);
    treeSort = maybeTreeSort(treeSort);
